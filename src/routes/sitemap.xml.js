...
async function getPosts() {
    const allPosts = await Client.query([Prismic.Predicates.at('document.type', 'even')], { pageSize : 100 })
    const postsURL = allPosts.results.reduce((newArr, currItem) => {
        let post = `https://christellepeuziat.netlify.app/agenda/${currItem.uid}`
